...
@testable import ShieldMark

final class KeychainStoreTests: XCTestCase {
    func testKeychainRoundTripData() throws {
        let keychain = KeychainStore(service: "com.example.ShieldMark.tests.keychain.\(UUID().uuidString)")
...
final class LockdownStateMachineTests: XCTestCase {
    func testLockdownTransitions() async throws {
        let keychain = KeychainStore(service: "com.example.ShieldMark.tests.lockdown.\(UUID().uuidString)")
...
final class ProofStoreTests: XCTestCase {
    func testProofCreateAndVerify() async throws {
        let keychain = KeychainStore(service: "com.example.ShieldMark.tests.proofs.\(UUID().uuidString)")
